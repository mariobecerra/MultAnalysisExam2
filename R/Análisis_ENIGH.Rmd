...
# tengan distitos valores iniciales
...
```{r, eval=FALSE}
mod1 <- FLXMRglm( ~ tam_loc+est_socio+clase_hog+sexo_jefe+educa_jefe+edad_jefe+educacion+Estado+AMBITO)
fittedModel <- stepFlexmix(ing_cor ~ 1, model = mod1, nrep = 3, k = 3, data = df_red1)
fittedModel2 <- stepFlexmix(ing_cor ~ ., model = mod1, nrep = 3, k = 3, data = df_red1)
```
