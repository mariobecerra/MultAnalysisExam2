...
jags.data.1 <- list("ing_cor", "est_socio", "clase_hog", "sexo_jefe", "N", "J")
...
jags.parameters.1 <-  c("sigma.y","b1","b2", "a", "mu.a", "sigma.a")
jags.fit.1 <- jags(data = jags.data.1, inits = jags.inits.1, 
  model.file = "./Modelos/modelo_1.txt", parameters.to.save = jags.parameters.1,
